...
if response.status_code == 200:
    ...
    with open('D:/Pictures/Saved Pictures/new_wallpaper.jpg','wb') as file:
...
ctypes.windll.user32.SystemParametersInfoW(20, 0, "D:/Pictures/Saved Pictures/new_wallpaper.jpg" , 0)
